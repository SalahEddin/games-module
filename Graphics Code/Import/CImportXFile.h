...
public:
	...
	// Get the specification and data for given sub-mesh, returned through a pointer. May request adjacency
	// data to be embedded in the face (index) list (for geometry shaders) and/or tangents to be calculated
	// Possible return values:
	//		kSuccess:			...
	//		kOutOfSystemMemory:	...
